...
export default function SectionAbout() {
  return (
    <>
      ...
      {/* Content + Divider */}
      <section className="relative z-10 w-full min-h-screen text-white pt-32 pb-16 sm:pb-32 px-6 flex flex-col items-center justify-center text-center overflow-visible">
        {/* Divider Glow */}
